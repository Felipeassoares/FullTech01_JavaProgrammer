...
//			throw new IllegalArgumentException("O código deve ser positivo em múltiplo de 10.");
//		}
//		
//		this.codigo = codigo;
//	}
	...
	public void setCodigo(int codigo) {
		try {
			...
			e.initCause(new NumberFormatException(
					"Erro gerado devido a inconsistência na entrada de dados."));
			throw e;
		}
	}
	...
	public void setCh(int ch) throws NoSuchFieldException, IllegalAccessException {
		if(ch <= 0) {
			throw new IllegalAccessException("A carga horária não foi informadqa corretamente.");
		}
	...
	public int compareTo(Curso o) {
		// a ordenação será feira pela descrição
	...
	public boolean equals(Object obj) {
		if(obj != null && obj instanceof Curso) {
			Curso c = (Curso)obj;
			if(this.getDescricao().equals(c.getDescricao()) && 
	...
	// método para retornar uma linha contendo os dados do curso para a listagem
